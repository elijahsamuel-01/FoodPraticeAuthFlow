...
import { createAccount } from "../../api/authAPIAdmin";
    ...
    <div>
      <All>
        <LoginCard>
          <Holder>
            <TextHold>
              <MainText>Create Admin FoodFLex Account</MainText>
              <Link to="/adminsignin">
                <SideText>
            ...
            <form action="" onSubmit={handleSubmiteNow}>
              <div className="mb-5">
                <div>
              ...
              <div className="mb-[10px]">
                <button
                  className="w-[100%] h-[35px] rounded-[5px] bg-[rgb(255,108,55)] text-white cursor-pointer"
                  type="submit"
                >
                  Sign Up
                </button>
              ...
              <div className="mb-[20px]">
                <div className="w-[100%] h-[35px] flex justify-center items-center border border-[#4285f4] cursor-pointer">
                  ...
                  <div className="w-[90%] h-[100%] bg-[#4285f4] flex justify-center items-center text-white">
                    Sign in with Google
                  </div>
                </div>
              </div>
              <div>
                <button className="w-[100%] h-[35px] rounded-[5px] bg-gray-200 text-black cursor-pointer">
                  Sign in with SSO
                </button>
              </div>
            </form>
